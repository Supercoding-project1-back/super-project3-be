...
public class PostController {
    ...
    @Operation(summary = "카테고리별 게시글", description = "카테고리별 게시글을 조회합니다.")
    ...
    @Operation(summary = "사용자별 게시글", description = "사용자별 게시글을 조회합니다.")
    ...
    @Operation(summary = "게시글 아이디로 조회", description = "게시글 아이디로 게시글을 조회합니다.")
    @GetMapping("/post/{id}")
    public ResponseEntity<PostResponse> getPost(@PathVariable Long id){
        return ResponseEntity.ok(postService.getPostById(id));
    }

    @Operation(summary = "새 게시글 등록", description = "새 게시글을 등록합니다.")
